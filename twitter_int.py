...
def load_api():
    ...
    consumer_key = '0DTxU5UQNdueIbtjEz7h5K0df'
    consumer_secret = 'xR3MnRBdEMuHKWbE2RBmk21EkvVmam1pDHTJoFCFIroZZMVnS1'
    access_token = '49683260-WLScqftO4G7nA49Eozrq6iY0g8dHItibGlkt607A5'
    access_secret = 'r3nYiy5tUaMsjOV7eKctYbKHceLTa1aFmxXoNUNlOeG0m'
...
def write_tweets(tweets, filename):
    ...
    df.to_sql('sawi_tweets_historical_new_int', engine, if_exists='append', dtype={'in_reply_to_status_id': sqlalchemy.types.BigInteger, 'in_reply_to_user_id': sqlalchemy.types.BigInteger}) 
